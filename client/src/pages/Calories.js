...
const Calories = () => {
  ...
  const calculateBMR = (e) => {
    ...
    const convertedHeight = heightUnit === 'in' ? height * 2.54 : height; // inches to cm
    const convertedWeight = weightUnit === 'lb' ? weight * 0.453592 : weight; // pounds to kg
      ...
      <div className="row">
        <div className="col-md-6 form-section">
          ...
          <form onSubmit={calculateBMR}>
            ...
            <div className="mb-3">
              <label htmlFor="body-fat" className="form-label">Body Fat Percentage*</label>
              <input type="number" className="form-control" id="body-fat" value={bodyFat} onChange={(e) => setBodyFat(e.target.value)} required />
            </div>
