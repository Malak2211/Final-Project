...
function Meals(){
  ...
  return(
    <div >
      ...
      <button id ='more'onClick={getResponse}>more</button>
      <div className='meals_container'>
      {meals.map((meals, index) => (
        <div className='meal_card' key={index}>
          <img src={meals.image_url} alt={meals.Name} className="meal_image" />
          <div className='meal_info'>
            <p><span className='meal_label'>Name:</span> {meals.Name}</p>
            <p><span className='meal_label'>Country:</span> {meals.Country}</p>
            <p><span className='meal_label'>Calories:</span> {meals.Calories}</p>
            <p><span className='meal_label'>Ingredients:</span> {meals.Ingredients.join(', ')}</p>
            <p><span className='meal_label'>Recipe:</span> {meals.Recipe}</p>
          </div>
        </div>
      ))}
      <p>{data}</p>
